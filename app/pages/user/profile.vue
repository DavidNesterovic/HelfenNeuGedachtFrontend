<template>
  <div class="max-w-5xl mx-auto px-4 py-5 sm:px-6 lg:px-8">
      ...
      <div class="max-w-3xl sm:mx-auto lg:max-w-none lg:flex lg:items-center lg:justify-between lg:gap-8">
        ...
        <div class="flex items-center gap-4">
          ...
          <div>
            ...
            <span class="mt-1.5 inline-block rounded-full bg-amber-500 text-white text-xs font-semibold px-2.5 py-0.5">
              {{ currentLevel }}
            </span>
          </div>
        </div>

        <div class="flex-1 lg:max-w-md mt-5 lg:mt-0">
          <div v-if="currentLevel !== 'Gold'" class="bg-blue-700/50 rounded-2xl px-4 py-3">
          ...
          <div v-else class="bg-blue-700/50 rounded-2xl px-4 py-3">
    ...
    <div class="mt-4 rounded-2xl bg-white px-4 py-4 shadow-sm border border-slate-100/50 flex items-center gap-3">
      ...
      <div class="flex-1 min-w-0">
        <p class="font-medium text-slate-900 text-[14px] sm:text-base">Engagement-Zertifikat</p>
        <p class="text-[12px] sm:text-sm text-slate-400">Für Bewerbungen & Co.</p>
      </div>
      <button class="shrink-0 w-9 h-9 rounded-xl bg-blue-600 hover:bg-blue-700 transition flex items-center justify-center shadow-sm shadow-blue-200">
      ...
      <div class="mt-6">
        ...
        <div class="space-y-3">
          <div
            ...
            :key="badge.name"
            class="rounded-2xl bg-white px-4 py-3.5 shadow-sm border border-slate-100/50 flex items-center gap-3"
          >
            ...
            <div class="flex-1 min-w-0">
              ...
              <p class="text-[12px] text-slate-400 truncate">{{ badge.description }}</p>
            </div>
            <div
              v-if="badge.unlocked"
      ...
      <div class="mt-6">
        ...
        <div class="rounded-2xl bg-white shadow-sm border border-slate-100/50 overflow-hidden">
          ...
          <div class="flex items-center gap-3 px-4 py-3.5 border-b border-slate-100">
            ...
            <span class="text-[13px] text-indigo-500 font-medium">Wochenende</span>
          </div>
          <div class="flex items-center gap-3 px-4 py-3.5 border-b border-slate-100">
            <svg viewBox="0 0 24 24" class="h-5 w-5 text-slate-400 shrink-0" fill="none" stroke="currentColor" stroke-width="1.8">
            ...
            <span class="text-[13px] text-indigo-500 font-medium">Vorarlberg</span>
          </div>
